...
class GetCharacterUseCaseImpl @Inject constructor(
    ...
    override fun getAllCharacter(offset: Int, limit: Int): Flow<com.rafaelroldan.dto.result.Result<CharacterModel>> {
    ...
    override fun getCharacterById(characterId: Int): Flow<com.rafaelroldan.dto.result.Result<CharacterModel>> {
